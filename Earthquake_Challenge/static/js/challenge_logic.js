...
function styleInfoE(feature) {
  return {
    opacity: 1,
    fillOpacity: 1,
    fillColor: getColorE(feature.properties.mag),
    color: "#000000",
    radius: getRadius(feature.properties.mag),
    stroke: true,
    weight: 0.5
...
// Retrieve major earthquake data
